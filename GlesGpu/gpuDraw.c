...
/*GLint attrib_list_fsaa[] =
{
	GL_SURFACE_TYPE, GL_WINDOW_BIT,
	EGL_BUFFER_SIZE,    0,
	EGL_DEPTH_SIZE,     16,
...
/* Light Position ( NEW ) */
static GLfloat LightPosition[] = { 0.0f, 5.0f, 0.0f, 1.0f };
...
void GLcleanup()
{
 ...
 if(created_gles_context) {
  //eglMakeCurrent( display, EGL_NO_SURFACE, EGL_NO_SURFACE, EGL_NO_CONTEXT ); TODO
