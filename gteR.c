...
void gteGPL_R(psxCP2Regs *regs) {
    ...
    gteFLAG = 0;
    if (GTE_SF(gteop)) {
        gteMAC1 = A1((((s64)gteMAC1 << 12) + (gteIR0 * gteIR1)) >> 12);
        gteMAC2 = A2((((s64)gteMAC2 << 12) + (gteIR0 * gteIR2)) >> 12);
        gteMAC3 = A3((((s64)gteMAC3 << 12) + (gteIR0 * gteIR3)) >> 12);
    }
    else {
