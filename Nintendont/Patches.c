...
static char *const KernelDst = (char*)KERNEL_DST_LO; //0x90100000;
// kernel address we first read into
static char *const KernelReadBuf = (char*)KERNEL_BUF_LO; //0x91000000;
static unsigned int KernelSize = 0;

static inline bool IsWiiU(bool isWiiVC)
{
