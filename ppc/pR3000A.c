...
static void rec##f() { \
	...
	/*ADDI(PutHWRegSpecial(CYCLECOUNT), GetHWRegSpecial(CYCLECOUNT), (u32)(psxCP2time[_fFunct_(psxRegs.code)] << 0));*/ \
...
#define RESTORE_REG(reg, offset) \
    if (reg != GetHWReg32(_Rt_)) { \
        LWZ(reg, offset, r1); \
    }
...
#define SW_LR_WRITEMEM(regIdx) \
    LIW(r4, (u32)(&psxMemWLUT)); \
    LWZX(r4, r4, r7); \
    CMPWI(r4, 0); \
    BEQ_L(bEndWriteDt); \
    STWBRX(regIdx, r4, r8); \
...
//#define debugSWLR(reg) \
//    SRWI(r26, r26, 2); \
//    SLWI(r26, r26, 16); \
//    ADD(r26, r26, r27); \
//    MR(r3Put, r26); \
//    MR(PutHWRegSpecial(ARG2), reg); \
//    ADDI(PutHWRegSpecial(ARG3), 0, r3Get); \
...
static void recSWL1() {
    ...
    SLWI(r5, r3, 8);
    OR(r5, r6, r5);
    SW_LR_WRITEMEM(r5); // (reg >> 24) | (mem & 0xffffff00)
    B_L(bEnd1);
    ...
    ANDIS(r5, r3, 0xffff);
    OR(r5, r6, r5);
    SW_LR_WRITEMEM(r5); // (reg >> 16) | (mem & 0xffff0000)
    B_L(bEnd2);
    ...
    ANDIS(r5, r3, 0xff00);
    OR(r5, r6, r5);
    SW_LR_WRITEMEM(r5);  // (reg >>  8) | (mem & 0xff000000)
    B_L(bEnd3);
...
static void recSWR1() {
    ...
    ANDI_(r5, r3, 0xff);
    OR(r5, r6, r5);
    SW_LR_WRITEMEM(r5); // (reg <<  8) | (mem & 0x000000ff)
    B_L(bEnd2);
    ...
    ANDI_(r5, r3, 0xffff);
    OR(r5, r6, r5);
    SW_LR_WRITEMEM(r5);  // (reg << 16) | (mem & 0x0000ffff)
    B_L(bEnd3);
    ...
    SRWI(r5, r3, 8);
    OR(r5, r6, r5);
    SW_LR_WRITEMEM(r5); // (reg << 24) | (mem & 0x00ffffff)
